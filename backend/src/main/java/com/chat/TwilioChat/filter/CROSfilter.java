...
public class CROSfilter implements Filter{
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		try 
		{
			...
			{
				String id = Jwts.parser().setSigningKey("MustBeUniqueEverwhereinuhgkjhgjkhgkjyygjuygwholeprogram").parseClaimsJws(httpRequest.getHeader("Authorization")).getBody().getSubject();				
